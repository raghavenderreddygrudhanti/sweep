...
pub fn app_cache_paths() -> Vec<(PathBuf, &'static str)> {
    ...
    vec![
        ...
        (
            support.join("Slack/Service Worker/CacheStorage"),
            "Slack Service Workers",
        ),
        ...
        (
            support.join("Spotify/PersistentCache"),
        ...
        (
            caches.join("com.microsoft.Powerpoint"),
        ...
        (
            support.join("Code/CachedExtensionVSIXs"),
